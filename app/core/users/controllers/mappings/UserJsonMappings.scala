...
import core.authentication.controllers.mappings.AuthenticationJsonMappings
import core.config.DateTimeJsonMappings
import play.api.libs.json._
import core.users.models.{User, UserId, UserRegistration}

trait UserJsonMappings extends LoginJsonMappings with AuthenticationJsonMappings with DateTimeJsonMappings {
