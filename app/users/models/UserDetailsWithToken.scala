...
private[users] case class UserDetailsWithToken(email: Email, username: Username, createdAt: Instant, updatedAt: Instant,
...
private[users] case class UserDetailsWithTokenWrapper(user: UserDetailsWithToken)
